...
class SettingsAPI {
	...
	public function get_element( $html ) {
		return WP_IRC_ . $this->format_key( $html ) . '';
	}
	// Hello echo
	 ...
	 */
	function show_forms() { ?>
		<?php $element = $this->get_element( 'settings-form' ); ?>
        <div class="metabox-holder">
			<?php foreach ( $this->settings_sections as $form ) { ?>
                <div id="<?php echo $form['id']; ?>" class="group" style="display: none;">
                    <form method="post" name="<?php echo $element; ?>" id="<?php echo $element; ?>" action="options.php">
						<?php
						do_action( 'wpirc_form_top_' . $form['id'], $form );
						settings_fields( $form['id'] );
						do_settings_sections( $form['id'] );
						do_action( 'wpirc_form_bottom_' . $form['id'], $form );
						?>
                        <div style="padding-left: 10px">
							...
							?>
                            <span class="button-secondary">But</span>
                        </div>
                    </form>
                </div>
			<?php } ?>
